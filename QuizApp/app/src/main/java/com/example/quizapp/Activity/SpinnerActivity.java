...
import com.example.quizapp.Models.LuckyItem;
import com.example.quizapp.Models.LuckyWheelView;
    ...
    void updateCash(int index) {
        ...
        database.collection("users")
            ...
            public void onSuccess(Void aVoid) {
                Toast.makeText(SpinnerActivity.this, "Coins are added in the account successfully.", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    }
