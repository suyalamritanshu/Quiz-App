...
import com.example.quizapp.Models.WithdrawRequest;
        ...
        binding.sendRequest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (user.getCoins() > 50000){
                    ...
                    Toast.makeText(getContext(), "You need more coins to continue your withdrawing process.", Toast.LENGTH_SHORT).show();
                }
            }
        });
